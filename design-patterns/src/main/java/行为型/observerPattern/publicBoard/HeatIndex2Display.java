 ...
 * 炎热指数
 */
public class HeatIndex2Display implements Observer, _2_DisplayElement {

    protected final WeatherData weatherData;
    private float temp;
    private float pressure;

    public HeatIndex2Display(WeatherData weatherData) {
    ...
    @Override
    public void display() {
        System.out.println("计算炎热指数 : " + computeHeatIndex(temp, pressure));
    }
