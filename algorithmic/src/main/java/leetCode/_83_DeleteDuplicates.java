...
public class _83_DeleteDuplicates {
    ...
    public static void main(String[] args) {
        ...
        //ListNode node = new _83_DeleteDuplicates().deleteDuplicates(nodes1);
        //node.print();
        ...
        //ListNode node = new _83_DeleteDuplicates().deleteDuplicates(nodes2);
        //node.print();

        //ListNode nodes3 = new ListNode(1);
        //nodes3.next = new ListNode(1);
        //nodes3.next.next = new ListNode(1);
        //ListNode node = new _83_DeleteDuplicates().deleteDuplicates(nodes3);
        //node.print();

        ListNode node = new _83_DeleteDuplicates().deleteDuplicates(null);
        node.print();
    }
}
